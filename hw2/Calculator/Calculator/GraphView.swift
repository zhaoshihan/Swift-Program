...
class GraphView: UIView {
   ...
   private var axesDrawer = AxesDrawer()
    ...
    @IBAction func origin(_ gesture: UITapGestureRecognizer) {
    ...
    @IBAction func scale(_ gesture: UIPinchGestureRecognizer) {
    ...
    @IBAction func originMove(_ gesture: UIPanGestureRecognizer) {
        switch gesture.state {
        case .began:
